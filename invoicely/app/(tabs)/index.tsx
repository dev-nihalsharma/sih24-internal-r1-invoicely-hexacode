...
export default function DashboardScreen() {
  ...
  const onSaveInvoice = async () => {
    ...
    if (!res.error) {
      ...
      setBillToPhone('');
      setBillFromPhone('');
      setInvoiceItems([{ description: '', hours: '', price: '' }]);
    ...
    <SafeAreaView style={globalStyles.AndroidSafeArea}>
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        >
          ...
          ></CustomTextInput>
          <Text style={globalStyles.subtitle_white}>
            {invoiceType.includes('company') ? 'Company Details' : 'Bill To'}
          </Text>
            ...
            <View>
              {recentInvoices.map((invoice) => (
                <InvoiceCard
                  key={invoice.id}
                  invoice={invoice}
                  invoicesList={recentInvoices}
                  setInvoicesList={setRecentInvoices}
                />
              ))}
            </View>
          ) : (
